const noop = () =>{};const NO_PARAMS={};const NO_HEADERS={}; const OK_200 = [200]
function request({method = 'GET',url,params =NO_PARAMS,requestType = 'json',responseType = 'json',headers = NO_HEADERS,body,checkStatus = false,onSuccess = noop, onError = noop, ok_responses = OK_200}) {
